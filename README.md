...
![Direct convolution, transposed convolution](img/deconvs-as-matrix.gif)
...
![Padded input with convolution leads to upsampling](img/padded-convs.jpg)
...
![Fractionally strided convolution](img/fractionally-strided-convs.jpg)
